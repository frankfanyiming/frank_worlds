...
runInNewContext(install,{window,document,location:{pathname:'/frog/'},lang:'en',Math,Set,Map});
...
window.xlandsState({menu:{items:[{id:25,text:'Kitchen',separator:false}]}});
...
window.xlandsState({menu:null,panel:null});assert(!document.body.classes.has('world-ui-open'));
