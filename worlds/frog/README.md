...
走过门槛后进入封闭的石屋室内：Blender 连续灰米色岩壁与拱顶围合两层空间，岩石表面保留自然起伏、矿物纹理和少量细裂纹。地面是不规则石板，夹层、楼梯和家具保留木材；圆形木窗配合柔和暖光。室外地形与树木在屋内停止显示，出门恢复庭院。室内全景和跟随视角限制在屋内，上夹层时调整镜头避开树干，C 仍可切换蛙眼视角。滚轮不会把室内镜头拉到屋外。
