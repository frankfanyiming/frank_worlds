...
export const PLACES: {id:PlaceId;title:string;subtitle:string;x:number;y:number;floor:number;description:string}[] = [
 ...
 {id:'bedroom',title:'大雄的房间',subtitle:'二楼 · 窗边的书桌',x:-10.75,y:3.3,floor:1,description:'绿窗帘、摊开的作业本，还有藏着童年秘密的壁橱。'},
 ...
 {id:'suneo',title:'小夫家',subtitle:'骨川家 · 绿瓦与阳台',x:-31,y:-24.4,floor:0,description:'宽宽的阳台和修整过的庭院，是街区里很好认的一户。'},
 {id:'gian',title:'胖虎家',subtitle:'刚田商店 · 街角杂货铺',x:-33.4,y:-1.3,floor:0,description:'绿白相间的遮阳棚下面，整齐摆着今天的蔬果。'},
...
export const ACTORS:Actor[]=[
 {id:'doraemon',name:'哆啦A梦',x:-11,y:-5.6,z:.133,color:'#008ac3',lines:['大雄，今天想去哪里？先回房间看看，还是去空地找大家？','二楼的窗边很舒服哦。走到楼梯前，就能上去。','竹蜻蜓能带你飞过屋顶，任意门能去想去的地方。时光机藏在你书桌的抽屉里哦。']},
...
export function insideHouse(x:number,y:number){
 return (x>-17.15&&x<-8.95&&y>.35&&y<8.55)||(x>-17.15&&x<-13.45&&y>-2.35&&y<=.35);
}
export function groundHeight(x:number,y:number,previous:number,surfaces:GroundSurface[]=[]){
 if(x>-13.46&&x<-12.64&&y>=HOUSE.stairY0&&y<=HOUSE.stairY1)
